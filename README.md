...
/* Efectos mejorados con Anime.js */
.laser-spot {
  position: absolute;
  width: 24px;
  height: 24px;
...
/* Efectos de retina mejorados */
.retina-sphere {
  animation: retinaPulse 8s infinite alternate;
}

@keyframes retinaPulse {
  0% { transform: scale(1); }
...
.blood-vessels {
  animation: vesselPulse 5s infinite alternate;
}
